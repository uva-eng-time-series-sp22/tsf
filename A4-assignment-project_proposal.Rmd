...
```{r set up coding environment 2, include=FALSE, message=FALSE}
...
```{r use ggplot2 to generate a plot 22}
...
```{r use ggplot2 to generate a plot 23}
...
```{r make a histogram of the data 2}
...
```{r perform automated time series decomposition 2}
